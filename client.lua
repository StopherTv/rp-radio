...
Radio.Commands = {
    {
        ...
        Help = "Basculer la radio dans la main", -- Command help shown in chatbox when typing the command
        Params = {},
